...
var pageManager = function(router, states) {
    ...
    // look for controllers folder in the root of the app (./node_module/slyn-page-manager/lib/)
    this.controllerContext = require.context("../../..", true, /(?:controllers)/);

    // look for templates folder in the root of the app
    this.templateContext = require.context("../../..", true, /(?:templates)/);
}
...
*/
var _instance = null;
module.exports.init = function(router, states, options){
    _instance = new pageManager(router, states, options);
}

module.exports.loadState = function(state, queryString){
    if(_instance === null)
        throw new Error('pageManager instance has not been instantiated');

    return _instance.loadState(state, queryString);
}

module.exports.findState = function(stateName){
    if(_instance === null)
        throw new Error('pageManager instance has not been instantiated');

    return _instance.findState(stateName);
}

module.exports.goTo = function(){
    if(_instance === null)
        throw new Error('pageManager instance has not been instantiated');

    return _instance.goTo();
}

module.exports.navigateTo = function(url, options){
    if(_instance === null)
        throw new Error('pageManager instance has not been instantiated');

    return _instance.navigateTo(url, options);
}

module.exports.instantiateView = function(options){
    if(_instance === null)
        throw new Error('pageManager instance has not been instantiated');

    return _instance.instantiateView(options);
}

module.exports.instantiateModel = function(options){
    if(_instance === null)
        throw new Error('pageManager instance has not been instantiated');

    return _instance.instantiateModel(options);
}

module.exports.setRoot = function(domEl){
    if(_instance === null)
        throw new Error('pageManager instance has not been instantiated');

    return _instance.setRoot(domEl);
}
